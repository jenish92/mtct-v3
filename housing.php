...
<div class="container-fluid px-lg-5">
   <div class="row pt-5 pb-5">
      <div class="col-lg-9 col-md-9 col-12">
          <div class="">
         <h2 class="text-center">Housing<span class="cus-color1"> the Poor</span></h2>
         <h6 class="text-center mb-5">
            Not all of us can do great things. But we can do small things with great love.
         </h6>
         <div class="text-justify mb-3">
            <p>Majority of Indians have per capita space equivalent to or less than a 10 feet x 10 feet room for their living, sleeping, cooking, washing and toilet needs. The average is 103 sq ft per person in rural areas and 117 sq ft per person in urban areas.
            </p>
         </div>
