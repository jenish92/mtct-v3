...
final class PayU
{
    ...
    CONST SUCCESS_URL = 'https://www.motherteresacharities.org/pay_u/test_response.php';
    CONST FAILURE_URL = 'https://www.motherteresacharities.org/pay_u/test_response.php';
    ...
    public function setHashKey($params){
        return $this->getHashKey($params);
    }
