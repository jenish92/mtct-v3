   ...
   <div class="row pt-5 pb-5">
      <div class="col-lg-9 col-md-9 col-12">
         ...
         <ul class="mtct-list">
            ...
            <li> <a href="#"title="View">
               <i class="fa fa-arrow-right" aria-hidden="true"></i>Accredited by UNO'S<strong>WORLD HEALTH ORGANISAION.</strong>                      
               </a>
            </li>
            <li> <a href="pdf/caf-2018.pdf"> 
               <i class="fa fa-arrow-right" aria-hidden="true"></i>Charities Aid Foundation (CAF).</a> 
            </li>
            <li class="popb"> 
               <a href="#"title="View"><i class="fa fa-arrow-right" aria-hidden="true"></i>NitiAyog 
               (Planning Commission of India).</a>
            </li>
            <li> <a href="pdf/Approval Letter for form CSR.PDF" title="View">
               <i class="fa fa-arrow-right" aria-hidden="true"></i>Govt. of India CSR Aproval - Reg No.CSR00002270   </strong> </a>
            </li>
         </ul>
      </div>
